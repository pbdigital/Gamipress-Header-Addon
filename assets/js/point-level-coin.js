jQuery("document").ready(function ($) {
  ...
  if (
    point_level_vars.redeem_screen &&
    point_level_vars.coins_img &&
    point_level_vars.current_coins
  ) {
    $(".header-aside")
      .prepend(`<a style="display: flex;align-items: center; margin-right: 35px" href="${point_level_vars.redeem_screen}" data-balloon-pos="down" data-balloon="Earn coins to unlock goodies" class="coins">
  ...
  if (
    point_level_vars.rank_img &&
    point_level_vars.points_needed &&
    point_level_vars.current_rank
  ) {
    $(".header-aside")
      .prepend(`<div style="display: flex;align-items: center;margin-right: 35px" class="gamification">
