...
function enqueue_point_level_admin_js() {
  wp_enqueue_script('admin-point-level-script', plugin_dir_url( __FILE__ ) . 'assets/js/_admin.js');
	wp_localize_script('admin-point-level-script', 'admin_point_level_vars', array(
...
function point_level_load_scripts() {
  ...
  if ($show_bar){
	...
	wp_enqueue_script('point-level-script', plugin_dir_url( __FILE__ ) . 'assets/js/point-level-coin.js');
